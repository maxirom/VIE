...
(function() {
	...
	VIE.prototype.StanbolConnector = function(options) {
		...
		var defaults = {
			...
			entityhub : {
				/*
				 * if set to undefined, the Referenced Site Manager @
				 * /entityhub/sites is used.
				 */
				/*
				 * if set to, e.g., dbpedia, referenced Site @
				 * /entityhub/site/dbpedia is used.
				 */
				site : undefined,
		...
		this.options.url = (_.isArray(this.options.url)) ? this.options.url
				: [ this.options.url ];
	...
	VIE.prototype.StanbolConnector.prototype = {
		...
		// ### _init()
		// Basic setup of the stanbol connector. This is called internally by
		// the constructor!
		// **Parameters**:
		// *nothing*
		// **Throws**:
		...
		_init : function() {
			...
			jQuery.ajaxSetup({
				converters : {
					"text application/rdf+json" : function(s) {
						return JSON.parse(s);
					}
				},
		...
		_iterate : function(params) {
			...
			if (params.urlIndex >= this.options.url.length) {
				params.error
						.call(
								this,
								"Could not connect to the given Stanbol endpoints! Please check for their setup!");
				return;
			}

			var retryErrorCb = function(c, p) {
				/*
				 * in case a Stanbol backend is not responding and multiple URLs
			...
			if (typeof exports !== "undefined"
				...
				return params.methodNode.call(this, params.url.call(this,
						params.urlIndex, params.args.options), params.args,
						params.success, retryErrorCb, params.complete);
			}

			return params.method.call(this, params.url.call(this,
					params.urlIndex, params.args.options), params.args,
					params.success, retryErrorCb);
