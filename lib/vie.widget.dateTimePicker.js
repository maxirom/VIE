        ...
        if (id != "name" && worthShowing(id, value)) {
          ...
          if (isDateAttribute(id)) {
            if (typeof value != "undefined") {
              ...
              input.attr("value", date.format("YYYY-MM-DD"));
              //input.attr("value", date.format(this.options.setFormat);
            }
...
function rulesForCreativeWork() {
  ...
  return [
    ...
    //new Rule(type, "dateCreated", "<=", "encodings", "dateCreated"),
    
    
    //new Rule(type, "dateCreated", "<=", "offers", "priceValidUntil"),
    ...
    //new Rule(type, "dateCreated", "<=", "reviews", "dateCreated"),
...
function rulesForEvent() {
  ...
  return [
    ...
    //new Rule(type, "startDate", ">=", "attendees", "birthDate"), 
    new Rule(type, "startDate", ">=", "performer", "birthDate"),
    //new Rule(type, "startDate", ">=", "performers", "birthDate"),
    new Rule(type, "startDate", "<=", "subEvent", "startDate"),
    new Rule(type, "endDate", ">=", "subEvent", "endDate")
    //new Rule(type, "startDate", "<=", "subEvents", "startDate"),
    //new Rule(type, "endDate", ">=", "subEvents", "endDate"),
    ];
}
...
function rulesForMovie() {
  ...
  return [
    ...
    //new Rule(type, "dateCreated", ">=", "actors", "birthDate"),
...
function rulesForMusicPlaylist() {
  ...
  return [
    ...
    //new Rule(type, "dateCreated", ">=", "tracks", "dateCreated"),
...
function rulesForOrganization() {
  ...
  return [
    ...
    //new Rule(type, "foundingDate", "<=", "reviews", "dateCreated"),
    //new Rule(type, "foundingDate", "<=", "reviews", "dateModified"),
    //new Rule(type, "foundingDate", "<=", "reviews", "datePublished")
...
function rulesForPerson() {
  ...
  return [
    ...
    //new Rule(type, "birthDate", ">=", "alumniOf", "foundingDate"),
    //new Rule(type, "birthDate", "<=", "children", "birthDate"),
    new Rule(type, "deathDate", ">=", "colleague", "birthDate"),
    //new Rule(type, "deathDate", ">=", "colleagues", "birthDate"),
    ...
    //new Rule(type, "birthDate", ">=", "parents", "birthDate"),
...
function rulesForTVSeries() {
  ...
  return [
    ...
    //new Rule(type, "dateCreated", "<=", "seasons", "startDate"),
